...
def get_cfg_defaults(cfg):
    ...
    cfg.MODEL.ROI_CUBE_HEAD.USE_CORNER_HEATMAP_AUX = False
    cfg.MODEL.ROI_CUBE_HEAD.LOSS_W_CORNER_HEATMAP = 0.02
    ...
    cfg.MODEL.ROI_CUBE_HEAD.GEOMETRY_APPLY_WARMUP_ITERS = 0
