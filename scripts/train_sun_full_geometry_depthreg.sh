...
OUTPUT_DIR="${OUTPUT_DIR:-output/training/SUN_full_geometry_depthreg}"
DEPTH_ROOT="${DEPTH_ROOT:-pseudo_label/SUNRGBD}"
DIST_URL="${DIST_URL:-tcp://0.0.0.0:12379}"
NUM_GPUS="${NUM_GPUS:-2}"

# Train with the full pseudo-label revision JSON only. No RSH, no CoP/GS,
# no latentbox: this isolates the pseudo-label contribution.
