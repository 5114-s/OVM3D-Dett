...
PL_FOLDER="${PL_FOLDER:-Omni3D_pl-amodal-cuboid}"
OUTPUT_DIR="${OUTPUT_DIR:-output/training/SUN_amodal_cuboid_depthreg}"
DEPTH_ROOT="${DEPTH_ROOT:-pseudo_label/SUNRGBD}"
DIST_URL="${DIST_URL:-tcp://0.0.0.0:12398}"
NUM_GPUS="${NUM_GPUS:-2}"

# Isolate the new pseudo-label generator:
#   no RSH / CoP-GS / ZEM / latent training head
#   yes cached UniDepth depth consistency
#   yes attribute-wise pseudo weights written by the pseudo-label JSON
