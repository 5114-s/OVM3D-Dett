...
PL_FOLDER="${PL_FOLDER:-Omni3D_pl-openbox-ovscan}"
OUTPUT_DIR="${OUTPUT_DIR:-output/training/SUN_openbox_ovscan_depthreg}"
DEPTH_ROOT="${DEPTH_ROOT:-pseudo_label/SUNRGBD}"
DIST_URL="${DIST_URL:-tcp://0.0.0.0:12401}"
NUM_GPUS="${NUM_GPUS:-2}"

# Isolate the pseudo-label route.  This keeps the detector head close to the
# best stable path: cached depth consistency + factorized pseudo weights.
