...
PL_FOLDER="${PL_FOLDER:-Omni3D_pl-gsam2-udv2-amodal-fast}"
OUTPUT_DIR="${OUTPUT_DIR:-output/training/SUN_gsam2_udv2_amodal_fast_depthreg}"
DEPTH_ROOT="${DEPTH_ROOT:-pseudo_label_gsam2_udv2/SUNRGBD}"
DIST_URL="${DIST_URL:-tcp://0.0.0.0:12396}"
NUM_GPUS="${NUM_GPUS:-2}"
