...
PL_FOLDER="${PL_FOLDER:-Omni3D_pl-supervised-boxer-lift}"
OUTPUT_DIR="${OUTPUT_DIR:-output/training/SUN_supervised_boxer_lift_depthreg}"
DEPTH_ROOT="${DEPTH_ROOT:-pseudo_label/SUNRGBD}"
DIST_URL="${DIST_URL:-tcp://0.0.0.0:12461}"
NUM_GPUS="${NUM_GPUS:-2}"

# Train OVM3D-Det on labels corrected by the supervised Boxer-style residual
# LiftHead.  Keep the stable ng-weighted route active: cached UniDepth
# front-surface depth consistency + factorized pseudo-label weights.
