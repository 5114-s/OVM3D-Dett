...
PL_FOLDER="${PL_FOLDER:-Omni3D_pl-gvo-step3}"
OUTPUT_DIR="${OUTPUT_DIR:-output/training/SUN_gvo_step3_depthreg}"
DEPTH_ROOT="${DEPTH_ROOT:-pseudo_label/SUNRGBD}"
DIST_URL="${DIST_URL:-tcp://0.0.0.0:12397}"
NUM_GPUS="${NUM_GPUS:-2}"

# Isolate the pseudo-label contribution of the Step3 GVO route.
# Keep the training recipe close to the strongest stable line:
# depth consistency + factorized pseudo weights, no RSH/CoP/ZEM/latent head.
